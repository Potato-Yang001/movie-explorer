...
export default function MovieSideBar() {
    ...
    return (
        <div className="position-relative">
            ...
            <div
                className={`position-fixed top-0 start-0 h-100 bg-white shadow-lg d-md-block`}
                style={{
                    width: '250px',
                    zIndex: 1050,
            ...
            <button
                className="btn btn-light position-fixed top-0 start-0 m-3 d-md-none shadow-sm"
                style={{
                    zIndex: 1060,
                    width: '45px',
                    height: '45px',
